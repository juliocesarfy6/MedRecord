...
export declare class MedicalRecordsController {
    ...
    findOne(req: any, id: string): Promise<import("../entities/medical-record.entity").MedicalRecord>;
    update(req: any, id: string, updateDto: UpdateMedicalRecordDto): Promise<import("../entities/medical-record.entity").MedicalRecord>;
